...
public class Inventory : MonoBehaviour
{
    ...
    public void Boleta()
    {
        ...
        foreach (var kvp in itemCounts)
        {
            ...
            {
                case "Red Donut": currentDiscount = totalItemPrice * 0.40f;
                    break;
                case "Red Apple": currentDiscount = totalItemPrice * 0.50f;
                    break;
                case "Roll Toilet": currentDiscount = totalItemPrice * 0.25f;
                    break;
            }
